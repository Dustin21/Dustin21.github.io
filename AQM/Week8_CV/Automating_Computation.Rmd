...
In this section we have a new project with a new cash flow stream, denoted `cashFlow_new`. The code looks very familiar, but now you need to experiment a bit on your own. I have left `DistcountRates` and `n` blank for you to fill in.

Examine the impact of the discount rates on the projects NPV of this cash stream and identify the IRR. Be careful on selecting the `seq()` of your `DiscountRates`. I recommend starting with a sequence as wide as possible and examining the plot, then shrinking it after locating the approximate vicinity of the IRR. Interpret your results and come up with a sound conclusion. Would you take this project? Under what circumstance would you take the project?
