...
6. **Present your Conclusion**. After your have fully analysed your results and have come up with a conclusion to your objective, state a clear and concise conclusion. Is there anything interesting that you would like to research further if you had more time?
...
* You will write a final team Markdown report including:
	...
	* A thourough analysis and interpretation of results and process you took to reach your results (analysing the data in different ways while making use of `dplyr`, etc)
	* Visualisations
	* Conclusion of your results and further possibilities
	* Remarks stating the difficulties you faced and how you solved them
* Each team member with push the final version of the Markdown report to their own repo. In addition, a printed copy will be handed in on Wednesday March 18th (Knit PDF in Markdown).
* There will be a 15 minute presentation of your project. Please use [R Presentation](https://support.rstudio.com/hc/en-us/articles/200486468-Authoring-R-Presentations) to compile your slides (works just like markdown, and run your code in them!) Here's a visial [example](http://slidify.org/samples/intro/#1) with a custom theme.
...
[Report Example](\Week11_API\Example.pdf): This is an example of how I expect your report would look like. [Here's another](http://kieranhealy.org/files/misc/pandoc-template-rmd-output-sample.png) (without the code of course).
